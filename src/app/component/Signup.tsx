        ...
        {step === 1 ? (
          <>
              ...
              {["User", "Business", "Contributor"].map((type) => (
                <label
                  ...
                  className={`flex cursor-pointer items-start gap-3 rounded-xl border border-gray-300 p-4 transition hover:border-[#0519CE] ${
                    form.userType === type ? "border-[#0519CE]" : "border-gray-300"
                  }`}
            ...
            <p className="mt-4 text-center text-sm text-gray-700">
              ...
              <button
                type="button"
                className="font-bold text-[#0519CE] underline cursor-pointer"
                onClick={() => {
                  setOpenSignupModal(false);
          ...
          <>
            ...
            <form className="space-y-6" onSubmit={handleSignup}>
              ...
              <div className="flex items-start gap-2 text-sm">
                ...
                />
                <label htmlFor="consent" className="text-gray-700 text-[13px]">
                  By creating an account, I agree to our
                  <Link href="/terms-and-conditions" className="font-normal text-[#0519CE] underline"> Terms & Conditions </Link>
                  and
                  <Link href="/privacy-policy" className="font-normal text-[#0519CE] underline"> Privacy Policy</Link>.
                </label>
              </div>
              ...
              <button
                ...
                className="w-full rounded-lg bg-[#0519CE] py-2 font-medium text-white transition hover:bg-[#0414a8] disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
              >
