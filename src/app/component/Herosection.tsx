    ...
    >
      ...
      <div className="flex lg:justify-start md:justify-center justify-center relative z-10 w-full lg:container lg:mx-auto px-6 md:px-12 lg:px-6 text-center md:text-left">
        <div className="text-white max-w-[700px] mx-auto md:mx-0">
          ...
          <h1
            id="hero-heading"
            className="font-['Righteous'] text-5xl sm:text-5xl md:text-6xl lg:text-[64px] font-normal my-[40px]"
          >
          ...
          {/* Accessible button */}
          <button
            className="font-['Montserrat'] bg-transparent border-2 border-white text-white font-semibold py-3 px-8 rounded-lg transition duration-300 focus:outline-none focus:ring-4 focus:ring-white focus:ring-offset-2 focus:ring-offset-transparent"
            type="button"
