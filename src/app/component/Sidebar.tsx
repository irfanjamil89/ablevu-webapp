...
export default function Sidebar() {
    ...
    return (
        <div className="h-screen w-[300px] pt-5 bg-white border-r border-gray-200 flex flex-col justify-between">
            {/* Top Navigation */}
            <div className="p-4">
                <ul className="space-y-4 font-medium">
                    ...
                    <li>
                        <a
                            href="/dashboard"
                            className="flex items-center gap-3 px-4 py-2 rounded-lg transition-all duration-150 bg-gray-200  text-gray-700 hover:bg-gray-100"
                    ...
                    <li>
                        <a href="/dashboard/business-type"
                            ...
                            {/* <svg version="1.1" id="icons_1_"
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="w-5 h-5 text-gray-600" x="0" y="0"
                                    viewBox="0 0 128 128"
                                    style="enable-background:new 0 0 128 128"
                                    xml:space="preserve"><style>.st0{fill:#0a0a0a}.st1{display:none}.st2{display:inline}</style><g
                                        id="row2_1_"><g id="_x36__3_"><path
                                            className="st0"
                    ...
                    {/* <!-- Accessible Cities --> */}
                    <li>
                        <a href="/dashboard/accessible-cities"
