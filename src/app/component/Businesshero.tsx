...
>
  {/* Content container */}
  <div className="flex lg:justify-start md:justify-center justify-center relative z-10 w-full lg:w-5/6 mt-10 py-20 lg:mx-auto px-6 md:px-12 lg:px-6 text-center md:text-left">
    <div className="text-black max-w-[550px] mx-auto md:mx-0">
      <h1 className="font-['Montserrat'] font-semibold text-5xl sm:text-5xl md:text-6xl  lg:text-[64px] my-[40px]">Make Your Business More Accessible Today
      </h1>
