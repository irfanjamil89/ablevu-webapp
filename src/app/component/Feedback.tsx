      ...
      <div
        ...
        <div
          ...
          <h2 className="text-2xl font-bold text-gray-700 mb-4">
            Share Feedback about AbleVu</h2>
          ...
          <form className="space-y-5">
            ...
            {/* <!-- Business Category --> */}
            <div>
              <label className="block text-md font-medium text-gray-700 mb-2">Select Feedback type</label>
              <select
            ...
            <div>
              <label className="block text-md font-medium text-gray-700 mb-2">Comments</label>
              <textarea
