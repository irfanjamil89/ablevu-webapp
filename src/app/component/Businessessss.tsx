                ...
                <div
                  ...
                  <div
                    ...
                    <form className="space-y-4">
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Upload Business Logo/Photo</label>
                        <div
                          className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:bg-gray-50 cursor-pointer">
                          <p className="text-blue-600 font-semibold text-sm">Click to upload</p>
                      ...
                      <div className="flex justify-center gap-3 pt-2">
                        ...
                        <button type="submit"
                          className="px-5 py-3 w-full text-center text-sm font-bold bg-[#0519CE] text-white rounded-full hover:bg-blue-700">
                          Create Business
                        </button>
                      </div>
                    </form>
            ...
            <section>
              ...
              <div>
                ...
                <div
                  ...
                  {/* <!-- left-side --> */}
                  <div
                    className="relative flex items-center justify-center w-full h-[160px] sm:h-[180px] md:h-auto md:w-[220px] shadow-sm bg-[#E5E5E5] bg-contain bg-center bg-no-repeat opacity-95"
