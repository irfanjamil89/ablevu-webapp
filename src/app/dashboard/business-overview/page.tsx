                ...
                <div className="w-full min-h-screen bg-white">
                    ...
                    <div className="w-full min-h-screen bg-white px-6 py-5">
                        ...
                        <div className="flex flex-wrap gap-y-4 items-center justify-between mb-8">
                            ...
                            <h1
                                className="text-2xl font-semibold text-gray-900"> My Business Profiles (1)</h1>
                            ...
                            <div className="flex flex-wrap gap-y-4 items-center gap-3">
                                ...
                                <input type="checkbox" id="business-overview-toggle" className="hidden peer" />

                                {/* <!-- OPEN BUTTON --> */}
                                <label htmlFor="business-overview-toggle"
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <p className="text-gray-600 text-sm mb-4">
                                            Please make sure that all the information provided is correct to the best of your knowledge as this will be visible to public.
                                        </p>
                                ...
                                {/* <!-- Search --> */}
                                <div
                                    className="flex items-center border border-gray-300 rounded-md px-3 py-2 w-auto lg:w-[250px] md:w-[180px]">
                                    ...
                                    <input
                                        type="text"
                                        placeholder="Search by Business Name, City, Country"
                        ...
                        {/* <section>
                            <div className="w-full min-h-[60vh] flex flex-col items-center justify-center text-center px-4 space-y-5">
                                <div className="mb-8">

                                    <div className="flex items-center justify-center">
                                        <span className="text-gray-400 text-sm"><img src="/assets/images/empty.avif"/></span>
                                    </div>
                                </div>

                                <p className="text-gray-700 text-md">
                                    You haven’t created a business yet. Click on the button below to<br />
                                    enlist your business on AbleVu
                                </p>

                                <div className='text-start'>

                                <input type="checkbox" id="empty-overview-toggle" className="hidden peer" />

                                <label htmlFor="empty-overview-toggle"
                                    className="px-6 py-3 text-sm font-bold bg-[#0519CE] text-white rounded-full cursor-pointer hover:bg-blue-700 transition">
                                    Add New Business
                                </label>
