...
useEffect(() => {
  ...
  fetch(process.env.API_BASE_URL+'/business-type/list')
  ...
  fetch(process.env.API_BASE_URL+'/accessible-feature-types/list')
    .then(response => response.json())
    .then(data => {
  ...
  // Fetch business list
  fetch(process.env.API_BASE_URL+'/business/list')
    .then(response => response.json())
    .then(data => {
